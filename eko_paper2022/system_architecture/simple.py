...
from benchmarks.stanford.tasti.tasti.eko.data.data_loader import ImageDataset, LabelDataset
from tqdm import tqdm
import time
from eko_paper2022.motivation.tasti_wrapper import InferenceDataset



class EKO_simple(Index):
    ...
    def get_reps(self):
        ...
        initial_anchor_count = int(0.8 * n_reps)
        ...
        assert(len(set(rep_indices)) * 2 >=  n_reps)
    ...
    def build_additional_anchors(self, target_dnn_cache, scoring_func):
        ...
        #print('initial dists', np.array(dists))
        #print('----------------------------')
        #print('temporal dists', np.array(temporal_dists))
        ...
        for i in range(n_reps - curr_len):
            ...
            #print('updated reps', rep_indices)
            #print('updated dists: ', dists)
            #print('-------------------------')
