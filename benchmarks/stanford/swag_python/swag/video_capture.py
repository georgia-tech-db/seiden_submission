...
class VideoCapture(object):
    ...
    def read(self): ## this function automatically moves to the next video when we are reading one video. This allows us to split multiple videos into small chunks.
