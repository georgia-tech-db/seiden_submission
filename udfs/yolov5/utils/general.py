...
from udfs.yolov5.utils.downloads import gsutil_getsize
from udfs.yolov5.utils.metrics import box_iou, fitness
...
def check_file(file, suffix=''):
    ...
    if Path(file).is_file() or file == '':  # exists
        ...
        files = []
        for d in 'data', 'models', 'eko_utils':  # search directories
...
def strip_optimizer(f='best.pt', s=''):  # from eko_utils.general import *; strip_optimizer()
